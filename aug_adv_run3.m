...
fprintf('\nValidation Accuracy (Aug Advanced Run3): %.2f%%\n', accuracy * 100);

fid = fopen('aug_adv_run3_accuracy.txt', 'w');
fprintf(fid, 'Validation Accuracy: %.2f%%\n', accuracy * 100);
fclose(fid);

save('aug_adv_run3_model.mat', 'trainedNet');
...
title('Training Progress: Aug Adv Run3');
grid on;
saveas(f, 'aug_adv_run3_training_plot.png');
close(f);
